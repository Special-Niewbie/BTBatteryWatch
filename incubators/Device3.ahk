/*
BTBatteryWatch Incubator - Device 3
...
if (!ErrorLevel) {
    MsgBox, 16, Warning, BTBatteryWatch.exe is not running. Device3.exe will be closed.
    ExitApp
}
...
Menu, Tray, Add, 👉 >>> Device 3 Menu <<<, TitleLabel
Menu, Tray, Icon, 👉 >>> Device 3 Menu <<<, % A_WorkingDir . "\asset\bt_batterywatch.ico"
Menu, Tray, Disable, 👉 >>> Device 3 Menu <<<
